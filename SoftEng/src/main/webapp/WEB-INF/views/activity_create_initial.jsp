...
<body>
	...
	<div class="container side-bordering">
		...
		<div class="row">
			...
			<form  modelAttribute="act" method="post" action="create_activity" enctype="multipart/form-data"/>
					<div class="col-6 form-group">
						<label path="name"><h4 class="my-4" id="activity-details-title">Activity Title</h4><label>
						<input  name="name" type="text" id="activity-form-title" placeholder="" class="form-control"/>
					</div>
