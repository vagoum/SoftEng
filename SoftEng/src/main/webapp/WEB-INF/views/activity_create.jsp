...
<body>
	...
	<div class="container side-bordering">
		...
		<div class="row">
			<form id="activity-form" action="activities/create.jsp" method="post" enctype="multipart/form-data" role="form" style="display: block;">
				...
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<h4 class="my-4" id="activity-photos-title">Select and Upload your photos</h4>
						...
						<div class="controls">
							<div class="entry input-group col-xs-3" style="padding-bottom: 7px;">
								...
								<input class="btn btn-primary" id="photo_file" name="photo_file" type="file"/>
					...
					<div class="form-group" style="padding-top: 20px; width: 50%">
						<label><h4 class="my-4" id="activity-date-title">Select Date</h4></label>
						<input type="date" class="form-control" id="activity-form-date" name="date" placeholder="Enter the activity name" required>
					</div>
