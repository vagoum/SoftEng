		...
		<div class="row text-center">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">			
				<div style="padding-bottom: 20px;"> <!-- class="col-md-4" -->
					<h3 class="my-4" id="activity-details-title">Oops! Something went wrong!</h3>
					<hr>
					<div id="activity-details-text">
						Some details here:<br>
						Even the things we love break sometimes. Thanks for your patience while we put the pieces back together.<br>
					</div>
				</div>
			</div>
		</div>
