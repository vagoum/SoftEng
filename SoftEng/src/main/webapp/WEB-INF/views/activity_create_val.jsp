...
<body>
	...
	<div class="container side-bordering">
		...
		<div class="row">
			...
			<form:form  modelAttribute="act" method="post" action="create_activity" enctype="multipart/form-data"/>
					<div class="col-6 form-group">
						<form:label path="name"><h4 class="my-4" id="activity-details-title">Activity Title</h4></form:label>
						<form:input path="name" name="name" type="text" id="activity-form-title" placeholder="" class="form-control"/>
					</div>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<div class="form-group" style="padding-top: 10px; margin-left: -10px; margin-right: -10px;">
						<div class="col-sm-6">
							<form:label path="ticketNumber"><h4 class="my-3">Number of Tickets</h4></form:label>
							<form:input path="ticketNumber" type="number" id="activity-form-ticket_number" name="ticketNumber" placeholder="20" class="form-control"/>
						</div>

						<div class="col-sm-6">
							<label><h4 class="my-3">Ticket Price</h4></label>
							<form:input path="cost" type="number" id="activity-form-ticket_price" name="cost" placeholder="8" class="form-control"/>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<div class="controls">
						<div class="entry input-group col-xs-3" style="padding-bottom: 7px;">
							...
							<form:input path="file" class="btn btn-primary" name="file" type="file"/>
					...
					<div class="form-group" style="padding-top: 20px; width: 50%">
						...
						<form:input path="date" type="date" id="activity-form-date" name="date" placeholder="Enter the activity name" class="form-control"/>
					</div>

					<div class="form-group" style="width: 50%">
						<label><h4 class="my-4" id="activity-details-title">Select Place</h4></label>
						<form:input path="address" type="text" id="activity-form-address" placeholder="Enter the event address" class="form-control"/>
					</div>
