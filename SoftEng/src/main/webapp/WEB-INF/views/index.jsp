...
<body>
	...
	<div class="container side-bordering">
		...
		<div class="row">
			...
			<div id="search_criteria" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12 col-xl-offset-3 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">Sort By:
				<div id="tab" class="btn-group" data-toggle="buttons-radio">
					<a href="#prices" class="btn" data-toggle="tab">Best Price</a>
					<a href="#features" class="btn" data-toggle="tab">Nearest</a>
			...
			<div class="activities">
				<div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-xs-12">
					<div class="card">
						...
						<div class="card-body">
							<img class="card-photo" src="http://cevirdikce.com/proje/hasem-2/images/finance-1.jpg">
							<p class="card-text">
				...
				<div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-xs-12">
					<div class="card">
						...
						<div class="card-body">
							<img class="card-photo" src="http://cevirdikce.com/proje/hasem-2/images/finance-2.jpg">
							<p class="card-text">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
							</p>
						</div>
				...
				<div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-xs-12">
					<div class="card">
						...
						<div class="card-body">
							<img class="card-photo" src="http://cevirdikce.com/proje/hasem-2/images/finance-3.jpg">
							<p class="card-text">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
							</p>
						</div>
