...
public class PdfCreator {
	...
	public static final String RESOURCE = "ticket_pic.png";
	 ...
	 * @throws IOException
	 */
	public void createPdf(String filename, Booking booking) throws DocumentException, IOException {
		...
		document.open();
		BaseFont fonty = BaseFont.createFont("arial.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
		fonty.setSubset(true);
		Font f1 = new Font(fonty, 22.0f, Font.BOLDITALIC, Color.BLACK);
		Font f2 = new Font(fonty, 10.0f, Font.BOLD, Color.BLACK);
		Font f3 = new Font(fonty, 8.0f, Font.NORMAL, Color.BLACK);
		Font f5 = new Font(fonty, 12.5f, Font.ITALIC, Color.BLACK);
