...
public class AdminControllerRest {
	...
	public String manageUsers(@RequestBody EmailActionWrapper demo) throws Exception {
		...
		if (user != null)
			...
			case "delete":
				...
				PasswordResetToken prt = passwordTokenRepository.findByUser(user);
				if (prt != null)
					passwordTokenRepository.delete(prt);
	...
	private SimpleMailMessage constructResetTokenEmail(String contextPath, final Locale locale, final String token,
			final User user) {
